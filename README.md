...
1. Create a **public** GitHub repository named `shuailiu-web.github.io` for your personal site.
2. Upload these files to the repository's root and commit them to the `main` branch.
3. In the repository, open **Settings → Pages**.
4. Under **Build and deployment**, choose **Deploy from a branch**, select `main` and `/(root)`, then save.
5. Wait for the Pages deployment, then visit [https://shuailiu-web.github.io/](https://shuailiu-web.github.io/).

GitHub Pages may take a few minutes to publish a first deployment. Each push to the selected branch will publish the latest version.
